...
class PortfolioList extends React.Component{
    ...
    render(){
        ...
        return(
            <div>
                <FilledInput className={this.props.classes.input} onChange={this.searchHandle} />

                <Select className={`${this.props.classes.input} ${this.props.classes.inputSel}`} onChange={this.selectHandle} value={this.state.searchBy}>
                        {types.map((itm, i) => {return (<option key={i} value={itm.id}>{itm.label}</option>)})}
                </Select>
                <div className={`${this.props.classes.flex} ${this.props.classes.flexSpaceBetween}`}>
                    <div className={`${this.props.classes.portfolios}`}>
